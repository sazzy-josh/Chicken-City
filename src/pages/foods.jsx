    ...
    return (
       <div className='flex items-center justify-center' key={id}>
         ...
         <motion.div
          ...
          key={id}
          className="rounded-lg flex border border-red-200 flex-col w-[180px] lg:w-[200px] h-[250px]  justify-around items-center relative bg-gradient-to-r from-slate-50 to-red-200 hover:border-red-400 hover:border-dotted shadow-xl cursor-pointer">
