  ...
  return (
    ...
    {/* Food delivery logo section */}
       ...
       className='py-4 text-4xl lg:text-5xl font-bold md:tracking-[normal] leading-[1.5] '> We offer the <span className='text-red-500'>Fastest Delivery </span>
        ...
        className='text-slate-50 text-bold gap-2 p-3 my-4 text-xs cursor-pointer rounded-full bg-red-500 w-[120px] shadow-lg sm:max-w-[140px] max-h-[80px]  font-bold flex justify-center items-center '>Order Now  <BsArrowRight className='font-bold' /></motion.p>
        
        <motion.p className='text-slate-50 text-bold gap-1 text-xs p-3 my-4 cursor-pointer rounded-full bg-red-500 w-[120px] shadow-lg sm:max-w-[160px] max-h-[80px]  font-bold flex justify-center items-center '>Book a Table  <BsArrowRight className='font-bold' /></motion.p>
